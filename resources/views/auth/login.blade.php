                ...
                <div class="space-y-2">
                    ...
                    <div class="relative group">
                        ...
                        <input type="email" name="email" required
                               value="{{ old('email') }}"
                               class="w-full pl-12 pr-4 py-4 bg-white border-2 {{ $errors->has('email') ? 'border-red-400 focus:border-red-600' : 'border-slate-100 focus:border-red-600' }} rounded-2xl focus:outline-none focus:ring-4 focus:ring-red-500/5 shadow-sm transition-all duration-300 text-slate-900 font-medium placeholder-slate-300"
                               placeholder="user@gmail.com">
                    </div>
                    @error('email')
                        <p class="text-xs text-red-500 font-semibold ml-1 mt-1 flex items-center space-x-1">
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative group">
                        ...
                        <input type="password" name="password" required
                               class="w-full pl-12 pr-12 py-4 bg-white border-2 {{ $errors->has('password') ? 'border-red-400 focus:border-red-600' : 'border-slate-100 focus:border-red-600' }} rounded-2xl focus:outline-none focus:ring-4 focus:ring-red-500/5 shadow-sm transition-all duration-300 text-slate-900 font-medium placeholder-slate-300"
                               placeholder="••••••••"
                               id="passwordInput">
