        ...
        <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden mb-8">
            ...
            <div class="p-8">
                ...
                <div id="content-komitmen" class="space-y-6">
                    <div class="flex items-center justify-between pb-4 border-b border-slate-100">
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-slate-400 font-semibold mt-0.5">Tentukan target penagihan Anda untuk bulan ini.</p>
                            </div>
                        </div>
                    ...
                    @else
                        <form action="{{ route('c3mr.storeKomitmen') }}" method="POST" class="max-w-md mx-auto space-y-5">
                            @csrf
                            <div>
                ...
                <div id="content-realisasi" class="hidden space-y-6">
                    ...
                    @else
                        ...
                        <form action="{{ route('c3mr.storeRealisasi') }}" method="POST" class="max-w-lg mx-auto space-y-5">
                            @csrf
                            <div>
