    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            <div class="flex items-center justify-between mb-4">
                <div>
                    <h1 class="text-4xl font-bold text-gray-900 mb-2">📊 C3MR</h1>
                    <p class="text-gray-600 text-lg">Customer Credit Management & Monitoring Report</p>
                </div>
                <a href="{{ route('collection.dashboard') }}" class="bg-purple-500 hover:bg-purple-600 text-white px-6 py-3 rounded-lg font-semibold transition-all duration-300 shadow-md hover:shadow-lg">
                ...
                <div id="content-komitmen" class="space-y-6">
                    <div class="flex items-center justify-between border-b pb-4">
                        <div>
                            ...
                            <p class="text-sm text-gray-500 italic">Tentukan target penagihan Anda untuk bulan ini.</p>
                        </div>
                ...
                <table class="w-full text-left border-collapse">
                    ...
                    <tbody class="divide-y divide-gray-100">
                        @forelse($activities as $activity)
                            <tr class="{{ $activity->type == 'komitmen' ? 'bg-purple-50/30' : '' }}">
