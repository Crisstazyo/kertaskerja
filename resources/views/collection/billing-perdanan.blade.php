            ...
            <div class="relative flex items-center justify-between">
                <div class="flex items-center space-x-6">
                    ...
                    <div>
                        ...
                        <h1 class="text-2xl font-black tracking-tight text-slate-900 leading-none uppercase">Billing <span class="text-red-600">Perdana</span></h1>
                        <p class="text-slate-400 text-xs font-bold mt-1 uppercase tracking-tight">Invoice Management & Processing System</p>
                    </div>
                </div>
        ...
        <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden mb-8">
            ...
            <div class="p-8">
                ...
                <div id="content-komitmen" class="space-y-6">
                    <div class="flex items-center justify-between pb-4 border-b border-slate-100">
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-slate-400 font-semibold mt-0.5">Tentukan target billing Anda untuk bulan ini.</p>
                            </div>
                        </div>
                    ...
                    @else
                        <form action="{{ route('billing.storeKomitmen') }}" method="POST" class="max-w-md mx-auto space-y-5">
                            @csrf
                            <div>
                                ...
                                <div class="relative">
                                    <input type="number" name="target_ratio" min="0" max="100" step="0.01" value="100" required
                                ...
                                <p class="text-xs text-center text-slate-400 font-semibold mt-2">Masukkan target ratio untuk periode ini (default: 100%)</p>
                            </div>
                    ...
                    @else
                        <div class="flex items-center justify-between pb-4 border-b border-slate-100">
                            <div class="flex items-center space-x-3">
                                <div class="w-1.5 h-8 bg-red-600 rounded-full"></div>
                                <div>
                                    <h2 class="text-base font-black text-slate-900 uppercase tracking-wide">Input Realisasi Billing</h2>
                        ...
                        <form action="{{ route('billing.storeRealisasi') }}" method="POST" class="max-w-lg mx-auto space-y-5">
                            @csrf
                            <div>
                                <label class="block text-xs font-bold text-slate-500 uppercase tracking-widest mb-2">Realisasi Billing (%)</label>
                                <div class="relative">
                    ...
                    <tbody class="divide-y divide-slate-100">
                        ...
                        <tr class="hover:bg-slate-50 transition-colors">
                            <td class="px-6 py-4 text-sm font-semibold text-slate-600">
                                {{ $activity->entry_date->translatedFormat('d M Y') }}
                            </td>
                            ...
                            <td class="px-6 py-4 text-right font-black {{ $activity->type == 'komitmen' ? 'text-red-600' : 'text-green-600' }}">
