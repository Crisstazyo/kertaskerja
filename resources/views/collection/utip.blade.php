    ...
    <div class="max-w-7xl mx-auto px-8 py-10">
            ...
            <div class="relative flex items-center justify-between">
                <div class="flex items-center space-x-6">
                    ...
                    <div>
                        ...
                        <p class="text-slate-400 text-xs font-bold mt-1 uppercase tracking-tight">Kelola Data UTIP Corrective & New UTIP</p>
                    </div>
                </div>
        ...
        <div class="flex items-center justify-between mb-5">
            <div class="flex items-center space-x-3">
                ...
                <h2 class="text-xl font-black text-slate-900 tracking-tight">UTIP</h2>
            </div>
            <span class="text-xs font-bold text-slate-500 bg-white border border-slate-200 rounded-full px-4 py-1.5 shadow-sm">Options Menu</span>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            $utipCards = [
                [
                    ...
                    'sub'   => 'Data perbaikan dan koreksi UTIP',
                    'badge' => 'CORRECTIVE',
                    'route' => route('collection.utip-corrective'),
                ...
                [
                    'label' => 'New UTIP',
                    'sub'   => 'Data UTIP baru dengan filter periode bulan/tahun',
                    'badge' => 'NEW',
                    'route' => route('collection.utip-new'),
                    'icon'  => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 9v3m0 0v3m0-3h3m-3 0H9m12 0a9 9 0 11-18 0 9 9 0 0118 0z"/>',
                ],
            ];
            @endphp

            @foreach($utipCards as $card)
            <a href="{{ $card['route'] }}"
