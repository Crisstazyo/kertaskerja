    ...
    <div class="max-w-7xl mx-auto px-8 py-10">
            ...
            <div class="relative flex items-center justify-between">
                <div class="flex items-center space-x-6">
                    ...
                    <div>
                        ...
                        <h1 class="text-2xl font-black tracking-tight text-slate-900 leading-none uppercase">CR <span class="text-red-600">SME</span></h1>
                        <p class="text-slate-400 text-xs font-bold mt-1 uppercase tracking-tight">Collection Ratio — Small Medium Enterprise</p>
                    </div>
                </div>
                ...
                <div id="content-komitmen" class="space-y-6">
                    <div class="flex items-center justify-between pb-4 border-b border-slate-100">
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                <h2 class="text-base font-black text-slate-900 uppercase tracking-wide">Input Komitmen Bulanan — SME</h2>
                                <p class="text-xs text-slate-400 font-semibold mt-0.5">Tentukan target collection ratio SME untuk bulan ini.</p>
                            </div>
                        </div>
                    ...
                    @else
                        <form action="{{ route('cr-sme.storeKomitmen') }}" method="POST" class="max-w-md mx-auto space-y-5">
                            @csrf
                            <div>
                    ...
                    @else
                        <div class="flex items-center justify-between pb-4 border-b border-slate-100">
                            <div class="flex items-center space-x-3">
                                <div class="w-1.5 h-8 bg-red-600 rounded-full"></div>
                                <div>
                                    <h2 class="text-base font-black text-slate-900 uppercase tracking-wide">Input Realisasi CR SME</h2>
                        ...
                        <form action="{{ route('cr-sme.storeRealisasi') }}" method="POST" class="max-w-lg mx-auto space-y-5">
                            @csrf
                            <div>
        ...
        <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
            <div class="px-8 py-5 border-b border-slate-100 flex items-center justify-between">
                <div class="flex items-center space-x-3">
                    <div class="w-1.5 h-8 bg-red-600 rounded-full"></div>
                    <h2 class="text-base font-black text-slate-900 uppercase tracking-wide">Riwayat Aktivitas CR SME</h2>
                </div>
            </div>
