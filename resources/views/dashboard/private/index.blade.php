    ...
    <div class="max-w-7xl mx-auto">
        <div class="bg-white rounded-2xl shadow-sm border border-slate-200 px-8 py-6 mb-8">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-black text-slate-900 uppercase mb-2">Private Dashboard</h1>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-slate-200 px-8 py-10">
            <p class="text-slate-600">Konten Private Dashboard akan ditampilkan di sini.</p>
        </div>
    </div>
</div>
@endsection
