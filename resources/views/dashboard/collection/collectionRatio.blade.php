        ...
        <div class="mb-8">
            <div class="flex items-center justify-between mb-4">
                <div>
                    ...
                    <p class="text-gray-600 text-lg">Collection Ratio</p>
                </div>
        ...
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden mb-8">
            ...
            <div class="p-8">
                        ...
                        <div class="bg-amber-50 border-l-4 border-amber-400 p-6 rounded-r-lg">
                            ...
                            <div class="mb-6">
                                ...
                                <div class="relative mt-1">
                                    <input type="text" value="{{ $ratio->first()->commitment ?? 0 }}" readonly class="block w-full p-4 text-4xl font-bold text-purple-700 border-2 border-purple-300 rounded-lg bg-purple-50 text-center" placeholder="0.00">
                ...
                <div id="content-realisasi" class="hidden space-y-6">
                    ...
                    <form action="{{ route('collection.cr.storeRealisasi') }}" method="POST" class="max-w-lg mx-auto space-y-6">
                        @csrf
                        <div>
                ...
                <table class="w-full text-left border-collapse">
                    ...
                    <tbody class="divide-y divide-gray-100">
                        @forelse($activities as $activity)
                            <tr class="{{ $activity->type == 'Collection Ratio' ? 'bg-purple-50/30' : '' }}">
                                ...
                                <td class="p-4 text-center font-bold {{ $activity->type == 'Collection Ratio' ? 'text-purple-700' : 'text-green-600' }}">
                                    {{ $activity->type}}
                                </td>
                                <td class="p-4 text-center font-bold {{ $activity->type == 'Collection Ratio' ? 'text-purple-700' : 'text-green-600' }}">
