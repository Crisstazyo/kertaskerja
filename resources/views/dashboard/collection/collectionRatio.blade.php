...
@section('title', 'Collection Ratio Management')
    ...
    <div class="max-w-7xl mx-auto px-8 py-10">
            ...
            <div class="relative flex items-center justify-between">
                <div class="flex items-center space-x-6">
                    ...
                    <div>
                        ...
                        <h1 class="text-2xl font-black tracking-tight text-slate-900 leading-none uppercase">Collection Ratio <span class="text-red-600">Management</span></h1>
                        <p class="text-slate-400 text-xs font-bold mt-1 uppercase tracking-tight">Collection Ratio Management</p>
                    </div>
                </div>
        ...
        <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden mb-8">
            ...
            <div class="p-8">
                ...
                <div id="content-komitmen" class="space-y-6">
                    ...
                    <div>
                        <label class="block text-xs font-bold text-slate-500 uppercase tracking-widest mb-2 text-center">Target Collection Ratio</label>
                        <div class="relative max-w-sm mx-auto">
                            <input type="text" value="{{ $ratio->first()->commitment ?? 0 }}" readonly
                ...
                <div id="content-realisasi" class="hidden space-y-6">
                    ...
                    <form action="{{ route('collection.cr.storeRealisasi') }}" method="POST" class="max-w-lg mx-auto space-y-5">
                        @csrf
                        <div>
                            <label class="block text-xs font-bold text-slate-500 uppercase tracking-widest mb-2">Realisasi Collection Ratio (%)</label>
                            <div class="relative">
        ...
        <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
            <div class="px-8 py-5 border-b border-slate-100 flex items-center justify-between">
                <div class="flex items-center space-x-3">
                    <div class="w-1.5 h-8 bg-red-600 rounded-full"></div>
                    <h2 class="text-base font-black text-slate-900 uppercase tracking-wide">Riwayat Aktivitas Collection Ratio</h2>
                </div>
                ...
                <table class="min-w-full">
                    <thead>
                        <tr class="bg-slate-50 border-b border-slate-100">
                            ...
                            <th class="px-6 py-3 text-center text-[10px] font-black text-slate-400 uppercase tracking-widest">Segment</th>
                    ...
                    <tbody class="divide-y divide-slate-100">
                        ...
                        <tr class="hover:bg-slate-50 transition-colors">
                            ...
                            <td class="px-6 py-4 text-center">
                                @if($activity->type == 'Collection Ratio')
                            ...
                            <td class="px-6 py-4 text-center font-black {{ $activity->type == 'Collection Ratio' ? 'text-red-600' : 'text-green-600' }}">
                                {{ number_format($activity->real_ratio ?? 0, 2) }}%
                            </td>
                            <td class="px-6 py-4 text-center font-black text-slate-700">
                                {{ $ratio->first()->commitment ?? 0 }}%
                            </td>
                        </tr>
                        @empty
                        <tr>
