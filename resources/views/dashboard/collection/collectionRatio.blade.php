...
<div class="min-h-screen" style="background:#f1f5f9;">
    <div class="max-w-7xl mx-auto px-8 py-10">
        ...
        {{-- ══ FLASH MESSAGE ══ --}}
        @if(session('success'))
        <div id="flash-message" class="flex items-center space-x-3 bg-green-50 border border-green-200 text-green-800 px-5 py-3.5 mb-6 rounded-xl text-sm font-semibold duration-300">
            ...
            <form action="{{ route('collection.cr.storeRealisasi') }}" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 mb-6">
                    ...
                    <!-- <div>
                        ...
                        <input type="hidden" name="commitment" placeholder="cth: Target Value"
        ...
        <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
            ...
            <div class="px-8 py-5 border-b border-slate-100">
                <div class="flex items-center space-x-3 mb-4">
                    <div class="w-1 h-6 bg-red-600 rounded-full"></div>
                    <h2 class="text-base font-black text-slate-900 uppercase tracking-wide">History Collections</h2>
                </div>
