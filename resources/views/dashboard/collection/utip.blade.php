            ...
            <div class="relative flex items-center justify-between">
                <div class="flex items-center space-x-6">
                    ...
                    <div>
                        ...
                        <h1 class="text-2xl font-black tracking-tight text-slate-900 leading-none uppercase">UTIP <span class="text-red-600">Management</span></h1>
                        <p class="text-slate-400 text-xs font-bold mt-1 uppercase tracking-tight">Unit Target Income Performance</p>
                    </div>
                </div>
                ...
                <div id="content-komitmen" class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="relative max-w-sm mx-auto">
                            <input id="commitment-value" type="text" value="{{ $utips->first()->commitment ?? 0 }}" readonly
                ...
                <div id="content-realisasi" class="hidden space-y-6">
                    <form action="{{ route('collection.utip.storeRealisasi') }}" method="POST" class="space-y-6">
                        ...
                        <div class="max-w-lg mx-auto space-y-5">
                            <div>
                                <label class="block text-xs font-bold text-slate-500 uppercase tracking-widest mb-2">Realisasi UTIP (%)</label>
                                <div class="relative">
                ...
                <table class="min-w-full">
                    ...
                    <tbody class="divide-y divide-slate-100">
                        ...
                        <tr class="hover:bg-slate-50 transition-colors">
                            ...
                            <td class="px-6 py-4 text-center font-black {{ Str::contains($activity->type, 'UTIP') ? 'text-red-600' : 'text-green-600' }}">
                                {{ $activity->type }}
                            </td>
                            <td class="px-6 py-4 text-center font-black {{ Str::contains($activity->type, 'UTIP') ? 'text-red-600' : 'text-green-600' }}">
