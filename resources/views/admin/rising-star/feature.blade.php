            ...
            <form action="{{ route('admin.rising-star.feature.store', $feature) }}" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 mb-6">
                    ...
                    <div>
                        ...
                        <input type="number" name="target_ratio" step="0.01" placeholder="cth: 110"
                    ...
                    <div>
                        <label class="block text-xs font-bold text-slate-500 uppercase tracking-widest mb-2">Realisasi Ratio (%)</label>
                        <input type="number" name="ratio_aktual" step="0.01" placeholder="cth: 115.5"
                            class="w-full px-4 py-2.5 border border-slate-200 rounded-lg text-sm font-semibold text-slate-800 focus:outline-none focus:border-red-400 focus:ring-1 focus:ring-red-100 transition-colors">
                    </div>
                </div>
                ...
                <table class="min-w-full" id="dataTable">
                    <thead>
                        <tr class="bg-slate-50 border-b border-slate-100">
                            ...
                            <th class="px-6 py-3 text-right text-[10px] font-black text-slate-400 uppercase tracking-widest">Realisasi Ratio</th>
                        ...
                        <tr class="hover:bg-slate-50 transition-colors">
                            ...
                            <td class="px-6 py-4">
                                <span class="text-xs font-bold rounded-md px-2.5 py-1
                                    {{ $item->type === 'komitmen' ? 'text-red-700 bg-red-50 border border-red-100' : 'text-green-700 bg-green-50 border border-green-200' }}">
                                    {{ ucfirst($item->type) }}
                                </span>
                            </td>
