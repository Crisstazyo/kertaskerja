...
@section('title', 'Progress Visiting HotD - Admin')
...
<div class="min-h-screen" style="background:#f1f5f9;">
    <div class="max-w-7xl mx-auto px-8 py-10">
                ...
                <div class="flex items-center space-x-6">
                    ...
                    <div>
                        ...
                        <h1 class="text-2xl font-black tracking-tight text-slate-900 leading-none uppercase">
                            Progress <span class="text-red-600">Visiting HotD</span>
                        </h1>
        ...
        <div class="bg-white rounded-2xl border border-slate-200 shadow-sm p-6 mb-6">
            <form method="GET" action="{{ route('admin.rising-star.progress.visiting-hotd') }}" class="flex flex-wrap gap-4 items-end">
                <div>
        ...
        <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
            <div class="px-8 py-5 border-b border-slate-100 flex items-center justify-between">
                <div class="flex items-center space-x-3">
                    ...
                    <h2 class="text-base font-black text-slate-900 uppercase tracking-wide">Data Visiting HotD</h2>
                </div>
