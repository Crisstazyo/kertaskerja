                ...
                <div
                    ...
                    <div class="flex flex-col sm:flex-row items-stretch sm:items-end gap-4">
                        ...
                        <div class="flex flex-col">
                            <label
                                class="text-xs font-bold text-slate-500 uppercase tracking-widest mb-1 invisible">Periode</label>
                        ...
                        <div class="flex flex-col">
                            <label
                                class="text-xs font-bold text-slate-500 uppercase tracking-widest mb-1 invisible">Search</label>
