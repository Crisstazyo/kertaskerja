...
<div class="min-h-screen" style="background:#f1f5f9;">
    <div class="max-w-7xl mx-auto px-8 py-10">
        ...
        <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden mb-8">
            <div class="px-8 py-5 border-b border-slate-100">
                <div class="flex items-center space-x-3">
                    ...
                    <h2 class="text-base font-black text-slate-900 uppercase tracking-wide">Input Data LOP Initiate — Private</h2>
                </div>
            </div>
            <div class="p-8">
                <form action="{{ route('admin.scalling.private.initiate.storeData') }}" method="POST">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 mb-6">
                        ...
                        {{-- Project Name --}}
                        <div>
                            <label class="block text-xs font-bold text-slate-500 uppercase tracking-widest mb-2">Project Name</label>
                        ...
                        {{-- Id LOP --}}
                        <div>
                            <label class="block text-xs font-bold text-slate-500 uppercase tracking-widest mb-2">Id LOP</label>
                        ...
                        {{-- CC --}}
                        <div>
                            <label class="block text-xs font-bold text-slate-500 uppercase tracking-widest mb-2">CC</label>
                        ...
                        {{-- Nipnas --}}
                        <div>
                            <label class="block text-xs font-bold text-slate-500 uppercase tracking-widest mb-2">Nipnas</label>
                        ...
                        {{-- AM --}}
                        <div>
                            <label class="block text-xs font-bold text-slate-500 uppercase tracking-widest mb-2">AM</label>
                        ...
                        {{-- Mitra --}}
                        <div>
                            <label class="block text-xs font-bold text-slate-500 uppercase tracking-widest mb-2">Mitra</label>
                        ...
                        <div>
                            <label class="block text-xs font-bold text-slate-500 uppercase tracking-widest mb-2">Plan Bulan Bill Comp</label>
                            <input type="text" name="plan_bulan_billcomp_2025" value="{{ old('plan_bulan_billcomp_2025') }}" placeholder="cth: 12"
                                class="w-full px-4 py-2.5 border border-slate-200 rounded-xl text-sm font-semibold text-slate-800 focus:outline-none focus:border-red-400 focus:ring-1 focus:ring-red-100 transition-colors">
                        </div>

                        {{-- Estimasi Nilai Bill Comp --}}
                        <div>
                            <label class="block text-xs font-bold text-slate-500 uppercase tracking-widest mb-2">Estimasi Nilai Bill Comp</label>
                            <input type="text" name="est_nilai_bc" value="{{ old('est_nilai_bc') }}" placeholder="cth: 1000000"
                                class="w-full px-4 py-2.5 border border-slate-200 rounded-xl text-sm font-semibold text-slate-800 focus:outline-none focus:border-red-400 focus:ring-1 focus:ring-red-100 transition-colors">
                        </div>
        ...
        <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
            <div class="px-8 py-5 border-b border-slate-100 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-5">

                <!-- Left Title -->
                <div class="flex items-center space-x-3">
                    <div class="w-1.5 h-8 bg-red-600 rounded-full"></div>
                    <h2 class="text-base font-black text-slate-900 uppercase tracking-wide">
                        Data LOP Initiate — Private
                    </h2>
                </div>
                ...
                <div class="flex flex-col sm:flex-row items-stretch sm:items-end gap-4">
                    ...
                    <div class="flex flex-col">
                        <label class="text-xs font-bold text-slate-500 uppercase tracking-widest mb-1 invisible">Periode</label>
                    ...
                    <!-- Search -->
                    <div class="flex flex-col">
                        <label class="text-xs font-bold text-slate-500 uppercase tracking-widest mb-1 invisible">Search</label>
                        <input type="text" id="filterSearch" placeholder="Cari data..."
                            oninput="filterTable()"
                ...
                <table class="min-w-full" id="dataTable">
                    <thead>
                        <tr class="bg-slate-50 border-b border-slate-100">
                            ...
                            <th class="px-6 py-3 text-left text-[10px] font-black text-slate-400 uppercase tracking-widest">Project Name</th>
                            <th class="px-6 py-3 text-left text-[10px] font-black text-slate-400 uppercase tracking-widest">Id LOP</th>
                            <th class="px-6 py-3 text-left text-[10px] font-black text-slate-400 uppercase tracking-widest">CC</th>
                            <th class="px-6 py-3 text-left text-[10px] font-black text-slate-400 uppercase tracking-widest">NIP NAS</th>
                            <th class="px-6 py-3 text-right text-[10px] font-black text-slate-400 uppercase tracking-widest">Mitra</th>
                            <th class="px-6 py-3 text-center text-[10px] font-black text-slate-400 uppercase tracking-widest">Plan Bulan Billcomp 2025</th>
                            <th class="px-6 py-3 text-center text-[10px] font-black text-slate-400 uppercase tracking-widest">Estimasi Nilai BC</th>
                    ...
                    <tbody class="divide-y divide-slate-100">
                        ...
                        <tr class="hover:bg-slate-50 transition-colors"
                            ...
                            <td class="px-6 py-4 text-sm font-bold text-slate-700">{{ $item->project ?? '—' }}</td>
                            ...
                            <td class="px-6 py-4 text-right text-sm font-black text-slate-800">{{ $item->mitra ?? '—' }}</td>
                        ...
                        <tr>
                            <td colspan="9" class="py-16 text-center">
                                ...
                                <p class="text-sm font-bold text-slate-400">Belum ada data initiate</p>
                            </td>
                        </tr>
                        @endforelse
                    </tbody>
