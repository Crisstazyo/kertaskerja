...
<div class="min-h-screen bg-gray-50 py-8">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            <div class="flex items-center justify-between mb-6">
                <div>
                    ...
                    <h1 class="text-3xl font-bold text-gray-900 mb-2">Scaling HSI Agency</h1>
                    <p class="text-gray-600">Admin input Commitment (SSL) - User input Real (SSL)</p>
                </div>
            </div>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-8">
            ...
            <form action="{{ route('admin.scalling.hsi-agency.store') }}" method="POST" class="space-y-4">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div>
                        <label for="commitment" class="block text-sm font-medium text-gray-700 mb-2">Commitment (SSL) - Optional</label>
                        <input type="number" 
                               id="commitment" 
                               name="commitment" 
                    ...
                    <div>
                        <label for="real" class="block text-sm font-medium text-gray-700 mb-2">Real (SSL) - Optional</label>
                        <input type="number" 
                               id="real" 
                               name="real" 
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
            <div class="p-6 border-b border-gray-200">
                <h2 class="text-xl font-bold text-gray-900">Data Scaling HSI Agency</h2>
            </div>
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Commitment (SSL)</th>
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Real (SSL)</th>
                        ...
                        @forelse($data as $index => $item)
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-semibold text-orange-600">
                                    {{ number_format($item->commitment, 0, ',', '.') }} SSL
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-semibold text-blue-600">
                                    {{ $item->real ? number_format($item->real, 0, ',', '.') . ' SSL' : '-' }}
                                </td>
