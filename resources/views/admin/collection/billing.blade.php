...
@section('title', 'Admin - Billing Perdana Management')
                ...
                <div class="flex items-center space-x-6">
                    ...
                    <div>
                        ...
                        <h1 class="text-2xl font-black tracking-tight text-slate-900 leading-none uppercase">
                            Collection <span class="text-red-600">Billing Perdana</span>
                        </h1>
                        <p class="text-slate-400 text-xs font-bold mt-1 uppercase tracking-tight">Input komitmen dan realisasi Billing Perdana</p>
                    </div>
                </div>
                ...
                <div id="content-komitmen" class="space-y-6">
                    <div class="flex items-center justify-between border-b pb-4 mb-6">
                        <div>
                            ...
                            <p class="text-sm text-slate-500 italic">Tentukan target ratio Billing Perdana untuk bulan ini</p>
                        </div>
                    ...
                    @else
                        <form action="{{ route('admin.collection.billing.store') }}" method="POST" class="max-w-md mx-auto bg-gray-50 p-6 rounded-xl border border-gray-200 shadow-sm">
                            @csrf
                    ...
                    @else
                        <div class="flex items-center justify-between border-b pb-4 mb-6">
                            <div>
                                ...
                                <p class="text-sm text-slate-500 italic">Input pencapaian ratio Billing Perdana hari ini</p>
                            </div>
                        ...
                        <form action="{{ route('admin.collection.billing.store') }}" method="POST" class="max-w-md mx-auto bg-gray-50 p-6 rounded-xl border border-gray-200 shadow-sm">
                            ...
                            <div class="mb-6">
                                <label class="block text-sm font-bold text-gray-700 mb-2 uppercase tracking-wide text-center">Realisasi Ratio Billing Perdana (%)</label>
                                <div class="relative mt-1">
        ...
        <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
            <div class="px-8 py-6 border-b border-slate-100 flex items-center justify-between">
                <div class="flex items-center space-x-3">
                    ...
                    <h3 class="text-base font-black text-slate-900 uppercase tracking-wide">💳 Data Billing Perdana Saya</h3>
                </div>
            ...
            <div class="flex flex-col items-center justify-center py-16 px-8">
                ...
                <p class="text-sm font-bold text-slate-400 uppercase tracking-wider">Belum ada data Billing Perdana</p>
        ...
        <div class="bg-white rounded-2xl shadow-2xl max-w-7xl w-full max-h-[90vh] overflow-hidden flex flex-col">
            ...
            <div class="px-8 py-6 border-b border-slate-200 bg-gradient-to-r from-red-50 to-white flex items-center justify-between">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h2 class="text-2xl font-black text-slate-900 tracking-tight">Progress Data Billing Perdana - Semua User</h2>
            ...
            <div class="flex-1 overflow-y-auto p-8">
                ...
                <div class="flex flex-col items-center justify-center py-16">
                    ...
                    <p class="text-sm text-slate-400 mt-1">Menunggu user mulai menginput data Billing Perdana</p>
                </div>
                @endif
            </div>
