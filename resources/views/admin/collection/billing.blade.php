        ...
        <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden mb-8">
            ...
            <div class="p-8">
                ...
                <div id="content-komitmen" class="space-y-6">
                    <div class="flex items-center justify-between pb-4 border-b border-slate-100">
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-slate-400 font-semibold mt-0.5">Tentukan target ratio Billing Perdana untuk bulan ini.</p>
                            </div>
                        </div>
                    ...
                    @else
                        <form action="{{ route('admin.collection.billing.store') }}" method="POST" class="max-w-md mx-auto space-y-5">
                            @csrf
                ...
                <div id="content-realisasi" class="hidden space-y-6">
                    ...
                    @else
                        <div class="flex items-center justify-between pb-4 border-b border-slate-100">
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-slate-400 font-semibold mt-0.5">Input pencapaian ratio Billing Perdana hari ini.</p>
                                </div>
                            </div>
                        ...
                        <form action="{{ route('admin.collection.billing.store') }}" method="POST" class="max-w-md mx-auto space-y-5">
                            ...
                            <div>
                                <label class="block text-xs font-bold text-slate-500 uppercase tracking-widest mb-2 text-center">Realisasi Ratio Billing Perdana (%)</label>
                                <div class="relative">
        ...
        <div class="bg-white rounded-2xl shadow-2xl max-w-7xl w-full max-h-[90vh] overflow-hidden flex flex-col border border-slate-200">
            ...
            <div class="px-8 py-6 border-b border-slate-100 relative overflow-hidden flex items-center justify-between">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h2 class="text-lg font-black text-slate-900 uppercase tracking-tight">Progress Data Billing Perdana — Semua User</h2>
            ...
            <div class="flex-1 overflow-y-auto p-8">
                ...
                <div class="py-16 text-center">
                    ...
                    <p class="text-xs text-slate-300 mt-1">Menunggu user mulai menginput data Billing Perdana</p>
                </div>
                @endif
            </div>
