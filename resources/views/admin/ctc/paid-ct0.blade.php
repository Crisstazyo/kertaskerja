    ...
    <div class="max-w-7xl mx-auto px-8 py-10">
            ...
            <div class="relative flex items-center justify-between">
                <div class="flex items-center space-x-6">
                    ...
                    <div>
                        ...
                        <p class="text-slate-400 text-xs font-bold mt-1 uppercase tracking-tight">Kelola data Paid CT0 semua user</p>
                    </div>
                </div>
        ...
        <div class="bg-white rounded-2xl border border-slate-200 shadow-sm p-8 mb-8">
            <div class="flex items-center space-x-3 mb-6">
                ...
                <h2 class="text-base font-black text-slate-900 uppercase tracking-wide">Input Data Paid CT0</h2>
            </div>

            <form action="{{ route('admin.ctc.paid-ct0.store') }}" method="POST">
                @csrf
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 mb-6">
                    ...
                    <div>
                        <label class="block text-xs font-bold text-slate-500 uppercase tracking-widest mb-2">Nominal</label>
                        <input type="number" name="nominal" required step="0.01" placeholder="0"
                            class="w-full px-4 py-2.5 border border-slate-200 rounded-lg text-sm font-semibold text-slate-800 focus:outline-none focus:border-red-400 focus:ring-1 focus:ring-red-100 transition-colors">
                    </div>
                </div>
        ...
        <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
            ...
            <div class="px-8 py-5 border-b border-slate-100">
                <div class="flex items-center space-x-3 mb-4">
                    <div class="w-1 h-6 bg-red-600 rounded-full"></div>
                    <h2 class="text-base font-black text-slate-900 uppercase tracking-wide">Data Paid CT0</h2>
                </div>
                <div class="grid grid-cols-6 gap-3">
                    ...
                    <div>
                        ...
                        <input type="text" id="filterSearch" placeholder="Cari region, user..." oninput="filterTable()"
                ...
                <table class="min-w-full" id="dataTable">
                    <thead>
                        <tr class="bg-slate-50 border-b border-slate-100">
                            ...
                            <th class="px-6 py-3 text-right text-[10px] font-black text-slate-400 uppercase tracking-widest">Nominal</th>
                    ...
                    <tbody class="divide-y divide-slate-100">
                        ...
                        <tr>
                            <td colspan="8" class="py-16 text-center">
                                ...
                                <p class="text-sm font-bold text-slate-400">Belum ada data Paid CT0</p>
                            </td>
                        </tr>
                        @endforelse
                    </tbody>
