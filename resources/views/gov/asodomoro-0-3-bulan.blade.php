...
<div class="min-h-screen" style="background:#f1f5f9;">
    <div class="max-w-7xl mx-auto px-8 py-10">
        ...
        <div class="flex items-start space-x-4 bg-amber-50 border border-amber-200 rounded-xl px-5 py-4 mb-8">
            ...
            <div>
                ...
                <p class="text-xs text-amber-700 mt-0.5">
                    Silakan input data realisasi Aosodomoro untuk periode 0-3 bulan. Target komitmen adalah <strong>70%</strong>.
                </p>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden mb-8">
            ...
            <div class="p-8">
                <form method="POST" action="{{ route('gov.asodomoro-0-3-bulan.store') }}">
                    @csrf
