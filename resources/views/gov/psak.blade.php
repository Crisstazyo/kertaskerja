    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            <div class="flex items-center justify-between mb-4">
                <div>
                    <a href="{{ route('gov.dashboard') }}" class="text-indigo-600 hover:text-indigo-800 mb-2 inline-block flex items-center gap-2">
