    ...
    <div class="max-w-[98%] mx-auto px-6">
        ...
        <div class="mb-8">
            <div class="flex items-center justify-between mb-6">
                ...
                <a href="{{ route('gov.scalling') }}" class="bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 text-white px-5 py-2.5 rounded-lg font-medium transition-all duration-200 shadow-lg hover:shadow-xl flex items-center gap-2 text-sm">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <table class="min-w-full divide-y divide-gray-200 text-xs">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr class="hover:bg-gray-50 transition-colors">
                                ...
                                <td class="px-2 py-2 text-center border-r bg-emerald-50">
                                    <span class="text-gray-700 text-xs">{{ $funnel->delivery_baut_bast ?? '-' }}</span>
                                </td>
                                <!-- BASO - Display text value -->
                                <td class="px-2 py-2 text-center border-r bg-emerald-50">
                                    <span class="text-gray-700 text-xs">{{ $funnel->delivery_baso ?? '-' }}</span>
                                </td>
                                ...
                                <td class="px-2 py-2 text-center border-r bg-violet-50 nilai-billcomp-cell" data-row-id="{{ $row->id }}">
                                    ...
                                    <span class="font-semibold text-gray-900">
                                        @php
                                            if ($funnel && $funnel->todayProgress && $funnel->todayProgress->delivery_billing_complete) {
                                                $nilaiToShow = $funnel->todayProgress->delivery_nilai_billcomp;
                                                if (!$nilaiToShow) {
