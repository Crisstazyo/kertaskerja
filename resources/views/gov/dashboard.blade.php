            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
                ...
                $scallingCards = [
                    [
                        ...
                        'badge' => 'ON-HAND',
                        'route' => route('gov.scalling-lop-table', 'on-hand'),
                    ...
                    [
                        ...
                        'badge' => 'QUALIFIED',
                        'route' => route('gov.scalling-lop-table', 'qualified'),
                    ...
                    [
                        ...
                        'badge' => 'KOREKSI',
                        'route' => route('gov.scalling-lop-table', 'koreksi'),
                    ...
                    [
                        ...
                        'badge' => 'INITIATE',
                        'route' => route('gov.scalling-lop-table', 'initiate'),
