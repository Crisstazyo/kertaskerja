...
@section('title', 'Private - LOP Koreksi')
                ...
                <div class="flex items-center gap-6">
                    ...
                    <div>
                        <div class="flex items-center gap-3 mb-1">
                            ...
                            <span class="px-3 py-1 bg-gradient-to-r from-pink-500 to-rose-600 text-white text-xs font-semibold rounded-full shadow-sm">Private</span>
                        </div>
