    ...
    <div class="max-w-7xl mx-auto px-8 py-10">
        ...
        <div class="mb-10">
            <div class="flex items-center justify-between mb-5">
                ...
                <span class="text-xs font-bold text-slate-500 bg-white border border-slate-200 rounded-full px-4 py-1.5 shadow-sm">LOP Private</span>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
                ...
                $scallingCards = [
                    [
                        ...
                        'badge' => 'ON-HAND',
                        'route' => route('private.scalling-lop-table', 'on-hand'),
                    ...
                    [
                        ...
                        'badge' => 'QUALIFIED',
                        'route' => route('private.scalling-lop-table', 'qualified'),
                    ...
                    [
                        'label' => 'LOP Koreksi',
                        'sub'   => 'Data LOP Koreksi Private',
                        'badge' => 'KOREKSI',
                        'route' => route('private.scalling-lop-table', 'koreksi'),
                    ...
                    [
                        ...
                        'badge' => 'INITIATE',
                        'route' => route('private.scalling-lop-table', 'initiate'),
        ...
        <div class="mb-10">
            <div class="flex items-center justify-between mb-5">
                ...
                <span class="text-xs font-bold text-slate-500 bg-white border border-slate-200 rounded-full px-4 py-1.5 shadow-sm">Private</span>
            </div>

            <div class="grid grid-cols-1 gap-5">
                <a href="{{ route('private.psak') }}"
                    class="group bg-white rounded-2xl border-2 border-slate-100 hover:border-red-200 shadow-sm hover:shadow-xl hover:shadow-red-500/10 transition-all duration-300 hover:-translate-y-1.5 overflow-hidden relative">
                    <div class="h-1 w-full bg-gradient-to-r from-red-600 to-red-400 opacity-0 group-hover:opacity-100 transition-all duration-300"></div>
                    <div class="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300"
                        style="background: radial-gradient(ellipse at top right, #fff1f2 0%, transparent 60%);"></div>
                    <div class="p-7 flex items-center space-x-6 relative">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-sm text-slate-500 font-medium mb-3">Kelola data PSAK untuk segmen Private</p>
