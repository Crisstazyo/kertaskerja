...
@section('title', 'Pilih Type - Private')
...
<div class="min-h-screen bg-gradient-to-br from-green-50 to-blue-50 py-12 px-4">
    <div class="max-w-4xl mx-auto">
        ...
        <div class="text-center mb-12">
            ...
            <h1 class="text-4xl font-bold text-gray-800 mb-2">Private Panel</h1>
        ...
        <div class="grid md:grid-cols-2 gap-8">
            <!-- Scalling Card -->
            <a href="{{ route('private.select-lop', 'scalling') }}" 
            ...
            <!-- PSAK Card -->
            <a href="{{ route('private.select-lop', 'psak') }}" 
