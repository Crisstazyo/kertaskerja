                ...
                <div class="flex items-center gap-6">
                    ...
                    <div>
                        <div class="flex items-center gap-3 mb-1">
                            ...
                            <span class="px-3 py-1 bg-gradient-to-r from-purple-500 to-indigo-600 text-white text-xs font-semibold rounded-full shadow-sm">Private</span>
                        </div>
                        <p class="text-sm text-gray-500">Qualified Lead Opportunity Pipeline</p>
                    </div>
                </div>
                <a href="{{ route('private.scalling') }}" class="bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 text-white px-5 py-2.5 rounded-lg font-medium transition-all duration-200 shadow-lg hover:shadow-xl flex items-center gap-2 text-sm">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <table class="min-w-full divide-y divide-gray-200 text-xs">
                        <thead class="bg-gradient-to-r from-slate-50 to-gray-100">
                            <tr>
                                ...
                                <th rowspan="2" class="px-4 py-2 text-left font-bold text-gray-700 uppercase tracking-wider border-r border-gray-300 bg-purple-100">ID LOP</th>
                                ...
                                <th rowspan="2" class="px-4 py-2 text-left font-bold text-gray-700 uppercase tracking-wider border-r border-gray-300 bg-purple-100">Mitra</th>
                        ...
                        <tfoot class="bg-gradient-to-r from-gray-50 to-gray-100">
                            <tr class="border-t-2 border-purple-500">
                                ...
                                <td class="px-4 py-4 text-center font-bold text-purple-700 text-lg border-r bg-purple-50">
                                    @php
                                ...
                                <td class="px-4 py-4 text-center font-bold text-violet-700 text-lg border-r bg-violet-50" id="total-nilai-billcomp">
                                    @php
                                        $totalBillComp = \App\Models\FunnelTracking::where('data_type', 'qualified')
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function saveRowChanges(rowId, dataType, rowData, button) {
        ...
        for (const [field, value] of Object.entries(changes)) {
            ...
            const promise = fetch('{{ route("private.funnel.update") }}', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'X-CSRF-TOKEN': csrfToken,
