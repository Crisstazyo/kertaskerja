...
@section('title', 'SME - Asodomoro 0-3 Bulan')
    ...
    <div class="max-w-7xl mx-auto px-8 py-10">
            ...
            <div class="relative flex items-center justify-between">
                <div class="flex items-center space-x-6">
                    ...
                    <div>
                        ...
                        <p class="text-slate-400 text-xs font-bold mt-1 uppercase tracking-tight">Input Realisasi Data Aosodomoro Periode 0-3 Bulan</p>
                    </div>
                </div>
        ...
        <div class="flex items-start space-x-4 bg-amber-50 border border-amber-200 rounded-xl px-5 py-4 mb-8">
            ...
            <div>
                ...
                <p class="text-xs text-amber-700 mt-0.5">
                    Silakan input data realisasi Aosodomoro untuk periode 0-3 bulan. Target komitmen adalah <strong>35%</strong>.
                </p>
            </div>
        </div>
            ...
            <div class="px-8 py-5 border-b border-slate-100">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-slate-400 font-semibold mt-0.5">Catat realisasi Aosodomoro periode 0-3 bulan.</p>
                    </div>
                </div>
            </div>

            <div class="p-8">
                <form method="POST" action="{{ route('sme.asodomoro-0-3-bulan.store') }}">
                    @csrf
        ...
        <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
            <div class="px-8 py-5 border-b border-slate-100 flex items-center justify-between">
                ...
                <span class="text-xs font-bold text-slate-500 bg-white border border-slate-200 rounded-full px-4 py-1.5 shadow-sm">0-3 Bulan</span>
            </div>
