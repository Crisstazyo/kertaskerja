    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            <div class="flex items-center justify-between mb-4">
                <div>
                    <a href="{{ route('sme.dashboard') }}" class="text-pink-600 hover:text-pink-800 mb-2 inline-block flex items-center gap-2">
            ...
            <div class="flex items-start space-x-3">
                ...
                <div>
                    ...
                    <p class="text-xs text-pink-800 leading-relaxed">
                        Silakan input data realisasi Asodomoro untuk periode 0-3 bulan. Target komitmen adalah <strong>35%</strong>.
                    </p>
                </div>
            </div>
        </div>
        ...
        <!-- Asodomoro Form -->
        <form method="POST" action="{{ route('sme.asodomoro-0-3-bulan.store') }}" class="space-y-6">
            @csrf
            ...
            <div class="flex justify-end space-x-4">
                <a href="{{ route('sme.dashboard') }}" class="bg-gray-300 text-gray-700 px-8 py-3 rounded-lg font-semibold hover:bg-gray-400 transition-all duration-200">
                    Batal
                </a>
