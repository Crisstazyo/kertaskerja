...
<div class="min-h-screen bg-gradient-to-br from-blue-50 to-purple-50 py-12 px-4">
    <div class="max-w-5xl mx-auto">
        ...
        <div class="text-center mb-12">
            ...
            <h1 class="text-4xl font-bold text-gray-800 mb-2">{{ ucfirst($type) }} - SME</h1>
        ...
        <div class="grid md:grid-cols-3 gap-6">
            <!-- Low -->
            <a href="{{ route('sme.lop-manage', [$type, 'low']) }}" 
            ...
            <!-- Medium -->
            <a href="{{ route('sme.lop-manage', [$type, 'medium']) }}" 
            ...
            <!-- High -->
            <a href="{{ route('sme.lop-manage', [$type, 'high']) }}" 
