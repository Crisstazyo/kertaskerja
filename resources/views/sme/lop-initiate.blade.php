        ...
        <div class="mb-8">
            <div class="flex items-center justify-between mb-6">
                <div class="flex items-center gap-6">
                    <a href="{{ route('sme.dashboard') }}" class="text-gray-500 hover:text-gray-700 transition-colors flex items-center gap-2 text-sm font-medium">
                    ...
                    <div>
                        <div class="flex items-center gap-3 mb-1">
                            ...
                            <span class="px-3 py-1 bg-gradient-to-r from-orange-500 to-amber-600 text-white text-xs font-semibold rounded-full shadow-sm">SME</span>
                        </div>
                    </div>
                </div>
