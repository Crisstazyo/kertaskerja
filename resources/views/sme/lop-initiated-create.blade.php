...
@section('title', 'SME - Add LOP Initiate Project')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center bg-primary text-white">
                    ...
                    <a href="{{ route('sme.lop.initiated') }}" class="btn btn-light btn-sm">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('sme.lop.initiated.store') }}" method="POST">
                        @csrf
