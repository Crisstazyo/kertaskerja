...
<div class="min-h-screen bg-gradient-to-br from-slate-50 via-gray-50 to-zinc-100 relative overflow-hidden">
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <!-- Scalling Card -->
        <div class="mb-10">
            <a href="{{ route('sme.scalling') }}" class="group block">
                            ...
                            <div class="relative">
                                <div class="flex items-start justify-between mb-4">
                                    <div>
                                        ...
                                        <p class="text-blue-100 text-sm">Kelola data HSI Agency & Telda</p>
                                    </div>
        ...
        <div class="bg-gradient-to-br from-pink-50 to-rose-50 rounded-2xl border-2 border-pink-200 shadow-xl p-8">
            <div class="flex items-center space-x-4 mb-6">
                ...
                <div>
                    ...
                    <p class="text-sm text-slate-600 mt-1">Program Asodomoro untuk meningkatkan kinerja SME</p>
                </div>
            </div>
