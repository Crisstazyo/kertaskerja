...
<div class="min-h-screen" style="background:#f1f5f9;">
    <div class="max-w-7xl mx-auto px-8 py-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
                ...
                $scallingCards = [
                    [
                        ...
                        'badge' => 'ON-HAND',
                        'route' => route('sme.scalling-lop-table', 'on-hand'),
                    ...
                    [
                        ...
                        'badge' => 'QUALIFIED',
                        'route' => route('sme.scalling-lop-table', 'qualified'),
                    ...
                    [
                        ...
                        'badge' => 'KOREKSI',
                        'route' => route('sme.scalling-lop-table', 'koreksi'),
                    ...
                    [
                        ...
                        'badge' => 'INITIATE',
                        'route' => route('sme.scalling-lop-table', 'initiate'),
        ...
        {{-- ══ 2. SCALLING — HSI AGENCY & TELDA ══ --}}
        <div class="mb-10">
            <div class="flex items-center justify-between mb-5">
                <div class="flex items-center space-x-3">
                    <div class="w-1.5 h-8 bg-red-600 rounded-full"></div>
                    <div>
                        <h2 class="text-xl font-black text-slate-900 tracking-tight">HSI Agency & Telda</h2>
                    </div>
                </div>
                <span class="text-xs font-bold text-slate-500 bg-white border border-slate-200 rounded-full px-4 py-1.5 shadow-sm">Scalling Extended</span>
            </div>

            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                {{-- HSI Agency --}}
                <a href="{{ route('sme.scalling.hsi-agency') }}"
                    class="group bg-white rounded-2xl border-2 border-slate-100 hover:border-red-200 shadow-sm hover:shadow-xl hover:shadow-red-500/10 transition-all duration-300 hover:-translate-y-1.5 overflow-hidden relative">
                    <div class="h-1 w-full bg-gradient-to-r from-red-600 to-red-400 opacity-0 group-hover:opacity-100 transition-all duration-300"></div>
                    <div class="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300"
                        style="background: radial-gradient(ellipse at top right, #fff1f2 0%, transparent 60%);"></div>
                    <div class="p-7 flex items-center space-x-6 relative">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-sm text-slate-500 font-medium mb-3">Input Realisasi HSI Agency</p>
                ...
                {{-- Scalling Telda --}}
                <a href="{{ route('sme.scalling.telda') }}"
                    class="group bg-white rounded-2xl border-2 border-slate-100 hover:border-red-200 shadow-sm hover:shadow-xl hover:shadow-red-500/10 transition-all duration-300 hover:-translate-y-1.5 overflow-hidden relative">
                    <div class="h-1 w-full bg-gradient-to-r from-red-600 to-red-400 opacity-0 group-hover:opacity-100 transition-all duration-300"></div>
                    <div class="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300"
                        style="background: radial-gradient(ellipse at top right, #fff1f2 0%, transparent 60%);"></div>
                    <div class="p-7 flex items-center space-x-6 relative">
                        ...
                        <div class="flex-1">
                            ...
                            <h3 class="text-xl font-black text-slate-900 tracking-tight mt-2 mb-1">Scalling Telda</h3>
                            <p class="text-sm text-slate-500 font-medium mb-3">Input Realisasi Telda</p>
                            <div class="flex items-center text-xs font-black text-slate-400 group-hover:text-red-600 uppercase tracking-widest transition-colors duration-200">
                                Open Data
                                <svg class="w-3.5 h-3.5 ml-1.5 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M9 5l7 7-7 7"/>
        ...
        <div class="mb-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                {{-- Asodomoro 0-3 Bulan --}}
                <a href="{{ route('sme.asodomoro-0-3-bulan') }}"
                    class="group bg-white rounded-2xl border-2 border-slate-100 hover:border-red-200 shadow-sm hover:shadow-xl hover:shadow-red-500/10 transition-all duration-300 hover:-translate-y-1.5 overflow-hidden relative">
                    <div class="h-1 w-full bg-gradient-to-r from-red-600 to-red-400 opacity-0 group-hover:opacity-100 transition-all duration-300"></div>
                    <div class="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300"
                        style="background: radial-gradient(ellipse at top right, #fff1f2 0%, transparent 60%);"></div>
                ...
                {{-- Asodomoro >3 Bulan --}}
                <a href="{{ route('sme.asodomoro-above-3-bulan') }}"
                    class="group bg-white rounded-2xl border-2 border-slate-100 hover:border-red-200 shadow-sm hover:shadow-xl hover:shadow-red-500/10 transition-all duration-300 hover:-translate-y-1.5 overflow-hidden relative">
                    <div class="h-1 w-full bg-gradient-to-r from-red-600 to-red-400 opacity-0 group-hover:opacity-100 transition-all duration-300"></div>
                    <div class="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300"
                        style="background: radial-gradient(ellipse at top right, #fff1f2 0%, transparent 60%);"></div>
