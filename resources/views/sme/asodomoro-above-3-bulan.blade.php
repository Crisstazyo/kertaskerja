    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            <div class="flex items-center justify-between mb-4">
                <div>
                    <a href="{{ route('sme.dashboard') }}" class="text-purple-600 hover:text-purple-800 mb-2 inline-block flex items-center gap-2">
            ...
            <div class="flex items-start space-x-3">
                ...
                <div>
                    ...
                    <p class="text-xs text-purple-800 leading-relaxed">
                        Silakan input data realisasi Asodomoro untuk periode lebih dari 3 bulan. Target komitmen adalah <strong>35%</strong>.
                    </p>
                </div>
            </div>
        </div>
        ...
        <!-- Asodomoro Form -->
        <form method="POST" action="{{ route('sme.asodomoro-above-3-bulan.store') }}" class="space-y-6">
            @csrf
