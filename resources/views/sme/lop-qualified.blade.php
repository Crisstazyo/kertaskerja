                ...
                <div class="flex items-center gap-6">
                    ...
                    <div>
                        <div class="flex items-center gap-3 mb-1">
                            ...
                            <span class="px-3 py-1 bg-gradient-to-r from-purple-500 to-indigo-600 text-white text-xs font-semibold rounded-full shadow-sm">SME</span>
                        </div>
                        <p class="text-sm text-gray-500">Qualified Lead Opportunity Pipeline</p>
                    </div>
                </div>
                <a href="{{ route('sme.scalling') }}" class="bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 text-white px-5 py-2.5 rounded-lg font-medium transition-all duration-200 shadow-lg hover:shadow-xl flex items-center gap-2 text-sm">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
