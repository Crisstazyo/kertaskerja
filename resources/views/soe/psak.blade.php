        ...
        <form id="psakForm">
            ...
            <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden mb-6">
                ...
                <div class="p-8 grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <div>
                        <label class="block text-xs font-bold text-slate-500 uppercase tracking-widest mb-2">Real (SSL)</label>
            ...
            <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden mb-8">
                ...
                <div class="p-8 grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <div>
                        <label class="block text-xs font-bold text-slate-500 uppercase tracking-widest mb-2">Real (Rp)</label>
